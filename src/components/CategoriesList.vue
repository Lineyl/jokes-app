      ...
      >
        ...
        >
          <figcaption class="font-semibold tracking-wide">
            <i
              class="fa-solid fa-tag text-muted-color-emphasis transition-all transition-duration-300"
              :class="{
                'fa-loading fa-tag':!isJokeLoading,
...
onMounted(async () => {
  ...
  if (!categoriesData) {
    throw new Error('Cloud not fatch categories');
  }
